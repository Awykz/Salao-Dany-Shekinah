export default function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 group hidden sm:flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-4 py-3.5 rounded-full shadow-2xl shadow-green-200 hover:shadow-green-300 transition-all duration-300 hover:-translate-y-1"
    >
      ...
      <span className="text-sm font-semibold pr-1">Fale Conosco</span>
      {/* Pulse ring */}
      <span className="absolute inset-0 rounded-full bg-green-400 opacity-20 animate-ping pointer-events-none" />
    </a>
  );
}
